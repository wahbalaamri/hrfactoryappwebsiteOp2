                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <select name="plan_id" id="plan_id" class="form-control" disabled>
                                            ...
                                            <option value="{{ $plan->id }}" @if($client_subscription->
                                                plan_id==$plan->id) selected @endif>{{ $plan->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    {{-- switch cycle_stat --}}
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label for="cycle_stat">{{ __('Will this survey will be pulsed frequently?')
                                            }}</label>
                                        <br>
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label for="reminder_stat">{{ __('Is there reminder should be send to
                                            respondents?')
                                            }}</label>
                                        <br>
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label for="mandatory_stat">{{ __('Is it must to collect all respondent answers before start next cycle?')
                                            }}</label>
                                        <br>
                                ...
                                <div class="row" id="cycle-row">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <div class="row">
                                            <input type="date" name="start_date" id="start_date"
                                                class="form-control col-4 m-1" placeholder="{{ __('Cycle Start Date') }}">
                                            <input type="time" name="start_time" id="start_time"
                                                class="form-control col-4 m-1" placeholder="{{ __('Cycle Start Time') }}">
                                        </div>
                                        @error('start_date')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <select name="reminder_duration_type" id="reminder_duration_type" class="form-control">
                                                <option value="">{{ __('Select Cycle') }}</option>
                                                <option value="1d"> {{ __('Every Day')}}</option>
                                                <option value="2d"> {{ __('Every Two Days')}}</option>
                                                <option value="3d"> {{ __('Every Three Days')}}</option>
                                        ...
                                        {{-- cycle start_date --}}
                                        <div class="form-group col-md-6 col-sm-12">
                                            <label for="reminder_start_date">{{ __('Reminder Start Date & Time') }}</label>
                                            <div class="row">
