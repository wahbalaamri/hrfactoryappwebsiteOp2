                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        ...
                        <div class="card-body p-0">
                            <form action="{{ $service?route('services.update',$service->id):route('services.store') }}"
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <select name="valid_in" id="valid_in" class="form-control">
                                                                ...
                                                                <optgroup label="{{ __('Arab Countries') }}">
                                                                    ...
                                                                    <option value="{{ $country->id }}"
                                                                        @if(old('valid_in',$service? $service->
                                                                ...
                                                                <optgroup label="{{ __('Other') }}">
                                                                    ...
                                                                    <option value="{{ $country->id }}"
                                                                        @if(old('valid_in',$service? $service->
                                                                        country:null)==$country->id) selected
                                                                        @endif>{{ $country->name }}
                                                                    </option>
                                                                    @endforeach
                                                                </optgroup>
                                                        ...
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            ...
                                                            <select name="type" id="type" class="form-control">
                                                                ...
                                                                <option value="1" @if(old('type',$service? $service->
                                                                    service_type:null)=="1") selected
                                                                    @endif>{{ __('Manual Builder') }}</option>
                                                                <option value="2" @if(old('type',$service? $service->
                                                                    service_type:null)=="2") selected
                                                                    @endif>{{ __('Files') }}</option>
                                                                <option value="3" @if(old('type',$service? $service->
                                                                    service_type:null)=="3") selected
                                                                    @endif>{{ __('Employee Engagment') }}
                                                                </option>
                                                                <option value="4" @if(old('type',$service? $service->
                                                                    service_type:null)=="4") selected
                                                                    @endif>{{ __('HR Diagnosis') }}</option>
                                                                <option value="5" @if(old('type',$service? $service->
                                                                    service_type:null)=="5") selected
                                                                    @endif>{{ __('360 Review') }}</option>
                                                                <option value="6" @if(old('type',$service? $service->
                                                                    service_type:null)=="6") selected
                                                                    @endif>{{ __('360 Review - Nama') }}</option>
                                                                <option value="7" @if(old('type',$service? $service->
                                                                    service_type:null)=="7") selected
                                                                    @endif>{{ __('Chat-bot') }}</option>
                                                                <option value="8" @if(old('type',$service? $service->
                                                                    service_type:null)=="8") selected
                                                                    @endif>{{ __('Calculator') }}</option>
                                                            </select>
                                                            {{-- validation --}}
                                                            @error('type')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        ...
                                                        <div class="form-group col-md-8 col-sm-12">
                                                            ...
                                                            <div class="col-12 text-center">
                                                                ...
                                                                @else checked @endif data-bootstrap-switch=""
