                            ...
                            <div class="bs-stepper linear">
                                <div class="bs-stepper-header" role="tablist">
                                    ...
                                    <div class="step active" data-target="#service-info">
                                        <button type="button" class="step-trigger" role="tab"
                                            aria-controls="service-info" id="service-info-trigger" aria-selected="true">
                                ...
                                <div class="bs-stepper-content">
                                    ...
                                    <div id="service-info" class="content active dstepper-block" role="tabpanel"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            ...
                                                            <input type="text" name="name" id="name" class="form-control"
                                                                placeholder="{{ __('Service Name in English') }}" value="{{ old('name') }}">
                                                            {{-- validation --}}
                                                            @error('name')
                                                        ...
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            <label for="name_ar">{{ __('Service Name (Arabic)') }}</label>
                                                            <input type="text" name="name_ar" id="name_ar" class="form-control"
                                                                placeholder="{{ __('Service Name in Arabic') }}" value="{{ old('name_ar') }}">
                                                            {{-- validation --}}
                                                            @error('name_ar')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        ...
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            ...
                                                            <input type="text" name="slug" id="slug" class="form-control"
                                                                placeholder="{{ __('Service Slug in English') }}" value="{{ old('slug') }}">
                                                            {{-- validation --}}
                                                            @error('slug')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        ...
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            <label for="slug_ar">{{ __('Service Slug (Arabic)') }}</label>
                                                            <input type="text" name="slug_ar" id="slug_ar" class="form-control"
                                                                placeholder="{{ __('Service Slug in Arabic') }}" value="{{ old('slug_ar') }}">
                                                            {{-- validation --}}
                                                            @error('slug_ar')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        ...
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            <label for="description">{{ __('Service Description (English)') }}</label>
                                                            <textarea name="description" id="description" class="form-control summernote"
                                                                placeholder="{{ __('Service Description in English') }}">{{ old('description') }}</textarea>
                                                            {{-- validation --}}
                                                            @error('description')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        ...
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            <label for="description_ar">{{ __('Service Description (Arabic)') }}</label>
                                                            <textarea name="description_ar" id="description_ar" class="form-control summernote"
                                                                placeholder="{{ __('Service Description in Arabic') }}">{{ old('description_ar') }}</textarea>
                                                            {{-- validation --}}
                                                        ...
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            <label for="objectives">{{ __('Service Objectives (English)') }}</label>
                                                            <textarea name="objectives" id="objectives" class="form-control summernote"
                                                                placeholder="{{ __('Service Objectives in English') }}">{{ old('objectives') }}</textarea>
                                                            {{-- validation --}}
                                                            @error('objectives')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        ...
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            <label for="objectives_ar">{{ __('Service Objectives (Arabic)') }}</label>
                                                            <textarea name="objectives_ar" id="objectives_ar" class="form-control summernote"
                                                                placeholder="{{ __('Service Objectives in Arabic') }}">{{ old('objectives_ar') }}</textarea>
                                                            {{-- validation --}}
                                                            @error('objectives_ar')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        ...
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            ...
                                                            <select name="valid_in" id="valid_in" class="form-control">
                                                                ...
                                                                <optgroup label="{{ __('Arab Countries') }}">
                                                                    ...
                                                                    <option value="{{ $country->id }}" @if (old('valid_in')==$country->id) selected
                                                                        @endif>{{ $country->name }}
                                                                    </option>
                                                                    @endforeach
                                                                </optgroup>
                                                        ...
                                                        <div class="form-group col-md-8 col-sm-12">
                                                            <label for="framework_video">{{ __('Service Framework Video') }} {{ __('Upload') }} <i
                                                                    class="fa fa-upload"></i>/{{ __('YouTube') }} <i
                                                                    class="fa fa-youtube"></i></label>
                                                            <div class="col-12 text-center">
                                                                <input type="checkbox" name="Framework_video_type" checked="" data-bootstrap-switch=""
                                                                    data-off-color="danger" data-on-color="success" value="1">
                                                            </div>
                                                            <div class="row">
                                                                <div id="uploadVideo" class="w-100 @error('youtube_link') d-none @enderror">
                                                                    <div class="form-group col-md-12 col-sm-12">
                                                                        <label for="framework_video">{{ __('Upload Video') }}</label>
                                                                        <input type="file" name="framework_video" id="framework_video"
                                                                            class="form-control">
                                                                        {{-- validation --}}
                                                                ...
                                                                <div id="youtubeVideo" class="@error('youtube_link') @else d-none @enderror w-100 text-center mt-3">
                                                                    {{-- preview youtube in iframe --}}
                                                                    <iframe src="" id="previewYouTube" class="d-none" frameborder="0"></iframe>
                                                                    <div class="form-group col-md-12 col-sm-12">
                                                                        <label for="youtube_link">{{ __('YouTube Video Link') }}</label>
                                                                        <textarea name="youtube_link" id="youtube_link" class="form-control"
                                                                            placeholder="{{ __('YouTube Video Link') }}" rows="5">{{ old('youtube_link') }}</textarea>
                                                                            {{-- hidden input for url --}}
                                                                        <input type="hidden" name="youtube_url" id="youtube_url" value="{{ old('youtube_url') }}">
                                                                        {{-- btnGetYouTube URL --}}
                                                                        <button type="button" class="btn btn-primary float-right mt-2"
                                                                            id="btnGetYouTubeURL">{{ __('Get YouTube Video') }}</button>
                                                                        {{-- validation --}}
                                                                        @error('youtube_link')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                        @enderror
                                                        ...
                                                        {{-- switch upload or youtube --}}
                                                        <div class="form-group col-md-8 col-sm-12">
                                                            <label for="framework_video">{{ __('Arabic Service Framework Video') }} {{ __('Upload') }} <i
                                                                    class="fa fa-upload"></i>/{{ __('YouTube') }} <i
                                                                    class="fa fa-youtube"></i></label>
                                                            <div class="col-12 text-center">
                                                                <input type="checkbox" name="Framework_video_type_ar" checked="" data-bootstrap-switch=""
                                                                    data-off-color="danger" data-on-color="success" value="1">
                                                            </div>
                                                            <div class="row">
                                                                <div id="uploadVideoAr" class="w-100 @error('youtube_link_ar') d-none @enderror">
                                                                    <div class="form-group col-md-12 col-sm-12">
                                                                        <label for="framework_video_ar">{{ __('Upload Video') }}</label>
                                                                        <input type="file" name="framework_video_ar" id="framework_video_ar"
                                                                            class="form-control">
                                                                        {{-- validation --}}
                                                                ...
                                                                <div id="youtubeVideo_ar" class="@error('youtube_link_ar') @else d-none @enderror w-100 text-center mt-3">
                                                                    {{-- preview youtube in iframe --}}
                                                                    <iframe src="" id="previewYouTubeAr" class="d-none" frameborder="0"></iframe>
                                                                    <div class="form-group col-md-12 col-sm-12">
                                                                        <label for="youtube_link_ar">{{ __('YouTube Video Link') }}</label>
                                                                        <textarea name="youtube_link_ar" id="youtube_link_ar" class="form-control"
                                                                            placeholder="{{ __('YouTube Video Link') }}" rows="5">{{ old('youtube_link_ar') }}</textarea>
                                                                            {{-- hidden input for url --}}
                                                                        <input type="hidden" name="youtube_url_ar" id="youtube_url_ar" value="{{ old('youtube_url_ar') }}">
                                                                        {{-- btnGetYouTube URL --}}
                                                                        <button type="button" class="btn btn-primary float-right mt-2"
                                                                            id="btnGetYouTubeURLAr">{{ __('Get YouTube Video') }}</button>
                                                                        {{-- validation --}}
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary float-right" onclick="stepper.next()">Next</a>
                                    </div>
                                            ...
                                            <div class="w-75">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4 col-sm-12">
                                                        <label for="feature">{{ __('Service Feature (English)') }}</label>
                                                        <input type="text" name="feature[]" id="feature" class="form-control"
                                                            placeholder="{{ __('Service Feature in English') }}" value="{{ old('feature[]') }}">
                                                        {{-- validation --}}
                                                        @error('feature')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    ...
                                                    <div class="form-group col-md-4 col-sm-12">
                                                        <label for="feature_ar">{{ __('Service Feature (Arabic)') }}</label>
                                                        <input type="text" name="feature_ar[]" id="feature_ar" class="form-control"
                                                            placeholder="{{ __('Service Feature in Arabic') }}" value="{{ old('feature_ar[]') }}">
                                                        {{-- validation --}}
                                                        @error('feature_ar')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    ...
                                                    <div class="form-group col-md-2 col-sm-12">
                                                        ...
                                                        <a href="javascript:void(0);" class="btn btn-primary form-control" id="addFeature">{{ __('Add') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <a href="javascript:void(0);" class="btn btn-primary" onclick="stepper.previous()">Previous</a>
                                        <a href="javascript:void(0);" class="btn btn-primary float-right" onclick="stepper.next()">Next</a>
                                    </div>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="w-75">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4 col-sm-12">
                                                        <label for="approach">{{ __('Service Approach (English)') }}</label>
                                                        <textarea name="approach[]" id="approach" class="form-control summernote"
                                                    ...
                                                    <div class="form-group col-md-4 col-sm-12">
                                                        <label for="approach_ar">{{ __('Service Approach (Arabic)') }}</label>
                                                        <textarea name="approach_ar[]" id="approach_ar" class="form-control summernote"
                                                    ...
                                                    <div class="form-group col-md-2 col-sm-12">
                                                        <label for="addApproach">{{ __('Add More Approach') }}</label>
                                                        <a href="javascript:void(0);" class="btn btn-primary form-control" id="addApproach">{{ __('Add') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
function getindex(MainString, SubString) {
    ...
    $("[name='Framework_video_type']").on('switchChange.bootstrapSwitch', function (event, state) {
        ...
        if (state == true) {
            ...
            $(this).parent().css("margin-left", "-139px");
