...
<body class="background-white">
    ...
    <header class="gradient-white box-shadow">
        <div class="background-secondry padding-tb-5px position-relative">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 margin-tb-25px">
                        <div class="text-center">
                            ...
                            <ul id="menu-main" class="nav-menu dropdown-dark">
                                <li>
                    ...
                    <div class="col-xl-5 col-lg-5 margin-tb-25px">
                        <div class="float-end">
                            <ul id="menu-main" class="float-end nav-menu dropdown-dark">
                                ...
                                <li><a href="{{ route('Home') }}#consultHR">{{ __('Consult') }}</a></li>
                                <li><a href="{{ route('Home.about-us') }}">{{ __('About Us') }}</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 padding-social">
                        <div class="d-none d-lg-block float-end model-link">
                            <ul class="list-inline text-center margin-0px social">
                                <li class="list-inline-item"><a class="twitter cms" data-contentId="105" href="#"><i
                                            class="fab fa-twitter"></i></a></li>
                                <li class="list-inline-item"><a class="youtube cms" data-contentId="106" href="#"><i
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <form action="" method="POST" data-bs-multi-step-form>
                                        @csrf
                                        ...
                                        <div class="my-wizard-continar">
                                            ...
                                            <fieldset>
                                                <legend class="mb-5 pb-5 mt-5 pt-5">{{ $loop->iteration
                                                    ...
                                                    {{$practice->questions->first()->question }}
                                                    @elseif (app()->getLocale()=='ar')
                                                    {{$practice->questions->first()->question_ar }}
                                                    {{-- @elseif (app()->getLocale()=='in')
                                                    {{$practice->questions->first()->QuestionIn }} --}}
                                                    @endif
                                                </legend>
                                                <div class="container-rad mb-5 pb-5 mt-5 pt-5">
                                                    <div class="radio-tile-group">
